...
#ifndef __RAL_RAS__gradient__
#define __RAL_RAS__gradient__
...
// VERSION 1
void gr1(int n, double *x, double *g, void *z);

// VERSION 2 (currently using)
void gr2(int n, double *x, double *g, void *z);

// The objective function to be defined
double fn(int n, double* x, void* z);
double fn_update(int n, double* x, int updated_item1, int updated_item2, void* z);
// the gradient function
void compute_gr1(int n, double *x, double *g, void *opt);
void compute_gr2(int n, double *x, double *g, void *opt);

#endif /* defined(__RAL_RAS__gradient__) */
