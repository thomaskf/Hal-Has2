...
void RALIterationNew (TempRateMats* rateMatrixList, int* topMatrix, int numLineTopMat,
		...
		TempRateMats* bestHundredRateMatrices, UserOptions* options, int num_chars, int saveToInterResult,
		ParameterSet& start_ps, VariableSet& start_vs, vector<string>* leafList);
...
void optimThread(TempRateMats* rateMatChkLst, int* topMatrix, int numLineTopMat, Alignment* alignment, int isReversible,
		...
		ThreadLocks* threadLocks, int* jobAllocated, TempRateMats* preInterResult, UserOptions* userOptions, int num_chars);
...
// ==================================================================================================
// The structures designed for multi-threads
// ==================================================================================================

typedef struct OptimThreadArguments
{
	int num_chars;
	TempRateMats* rateMatChkLst;
	int* topMatrix;
	int numLineTopMat;
	Alignment* alignment;
	int isReversible;
	int numSpecies;
	int numIterations;
	vector<ParameterSet>* ps_threads;
	vector<VariableSet>* vs_threads;
	int masterThresID;
	int threadID;
	int availCPUs;
	ThreadLocks* threadLocks;
	int* jobAllocate;
	TempRateMats* preInterResult;
	ofstream* fout;
	int numItems;
	UserOptions* userOptions;
} OptimThreadArguments;

typedef struct RALIterationArguments
{
	TempRateMats* rateMatrixToChk;
	int* topMatrix;
	int numLineTopMat;
	Alignment* alignment;
	int isReversible;
